...
/**
 * Created by Shubham Bhasin on 28-Mar-16.
 */
...
public class HorizontalList extends BaseAdapter {
    ...
    public HorizontalList(Context c, String[] names, HashMap<Integer, Bitmap> Images) {
        mContext = c;
        this.Images = Images;
        this.names = names;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        grid = inflater.inflate(R.layout.single_horizontal_list, null);
